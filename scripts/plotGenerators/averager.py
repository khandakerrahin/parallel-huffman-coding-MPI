...
def create_averages(parent_dir, codeType):
    ...
    for size in problem_size:
        ...
        serial_files = [f"run_00{i + 1}_{size}_words.csv" for i in range(10)]
        ...
        parallel_times = [average_csv_files(d, [f"run_00{i + 1}_{size}_words.csv" for i in range(10)]) for d in
                          parallel_dirs]
