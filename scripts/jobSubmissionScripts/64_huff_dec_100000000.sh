...
# 64 cpu
mpirun.actual -n 64 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/64_100000000_words_encoded.bin /home/shaker.khandaker/decodedFiles/64_100000000_words.txt