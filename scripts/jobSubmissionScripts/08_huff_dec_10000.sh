...
# 8 cpu
mpirun.actual -n 8 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/08_10000_words_encoded.bin /home/shaker.khandaker/decodedFiles/08_10000_words.txt