...
# 32 cpu
mpirun.actual -n 32 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/32_100000000_words_encoded.bin /home/shaker.khandaker/decodedFiles/32_100000000_words.txt