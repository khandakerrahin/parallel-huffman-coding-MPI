...
# 2 cpu
mpirun.actual -n 2 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_compress /home/shaker.khandaker/inputFiles/10000_words.txt /home/shaker.khandaker/encodedFiles/02_10000_words_encoded.bin