...
# 8 cpu
mpirun.actual -n 8 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_compress /home/shaker.khandaker/inputFiles/300000000_words.txt /home/shaker.khandaker/encodedFiles/08_300000000_words_encoded.bin