...
# 02 cpu
mpirun.actual -n 32 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/32_6.5MB_text_encoded.bin /home/shaker.khandaker/decodedFiles/32_6.5MB_text.txt