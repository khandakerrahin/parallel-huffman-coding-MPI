...
# 128 cpu
mpirun.actual -n 128 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/128_1000_words_encoded.bin /home/shaker.khandaker/decodedFiles/128_1000_words.txt