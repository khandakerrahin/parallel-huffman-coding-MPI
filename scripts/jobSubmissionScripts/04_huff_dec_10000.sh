...
# 4 cpu
mpirun.actual -n 4 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/04_10000_words_encoded.bin /home/shaker.khandaker/decodedFiles/04_10000_words.txt