...
# 2 cpu
mpirun.actual -n 4 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_compress /home/shaker.khandaker/inputFiles/6.5MB_text.txt /home/shaker.khandaker/encodedFiles/04_6.5MB_text_encoded.bin