...
# 1 cpu
mpirun.actual -n 50 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/1000_words_encoded.bin /home/shaker.khandaker/decodedFiles/1000_words.txt