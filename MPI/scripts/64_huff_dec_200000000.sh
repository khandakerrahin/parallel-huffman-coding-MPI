...
# 1 cpu
mpirun.actual -n 100 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/200000000_words_encoded.bin /home/shaker.khandaker/decodedFiles/200000000_words.txt