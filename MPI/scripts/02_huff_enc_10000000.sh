...
# 1 cpu
mpirun.actual -n 10 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_compress /home/shaker.khandaker/inputFiles/10000000_words.txt /home/shaker.khandaker/encodedFiles/10000000_words_encoded.bin