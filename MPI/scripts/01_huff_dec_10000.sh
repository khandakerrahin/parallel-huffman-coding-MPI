...
# 1 cpu
mpirun.actual -n 1 valgrind --leak-check=full --show-leak-kinds=all ./shaker_huffman/bin/MPI_decompress /home/shaker.khandaker/encodedFiles/10000_words_encoded.bin /home/shaker.khandaker/decodedFiles/10000_words.txt